...
export default async function HomePage() {
  ...
  return (
    <AppShell
      eyebrow="Anonymous Arena"
      heading="Launch a private photo bracket in seconds."
      subheading="Create a temporary session, upload competitors from your phone, and watch the simulator play out one dramatic match at a time."
      ...
      <section className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="glass-panel-strong rounded-[2rem] p-6 sm:p-8">
          <p className="max-w-xl text-sm leading-7 text-[var(--ink-soft)] sm:text-base">
            Bracket Blitz keeps everything anonymous. Sessions expire automatically, uploaded photos are stored in a temporary tournament folder, and one tap advances each match until the podium is ready.
          </p>
